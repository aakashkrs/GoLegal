          ...
          <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul className="navbar-nav justify-content-end">
              <li className="nav-item d-flex align-items-center">
                {/* <a className="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" rel="noopener noreferrer" href="https://www.creative-tim.com/builder?ref=navbar-material-dashboard">Online Builder</a> */}
              </li>
              <li className="mt-2">
              ...
              <li className="nav-item d-flex align-items-center">
                <Link to="./pages/sign-in.html" className="nav-link text-body font-weight-bold px-0">
